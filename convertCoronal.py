...
patient_folders = [f"CA{i+1:03}" for i in range(35, 47)]
...
for patient_folder in patient_folders:
    ...
    coronal_image_data = np.transpose(axial_image_data, (2, 0, 1))
    coronal_label_data = np.transpose(axial_label_data, (2, 0, 1))
